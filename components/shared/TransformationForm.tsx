...
const TransformationForm = ({
  ...
  const [transformation, setTransformation] = useState<Transformations | null>(
    null
  );
  ...
  const onTransformHandler = async () => {
    ...
    setTransformationConfig(
      deepMergeObjects(transformation, transformationConfig)
    );
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="flex flex-col gap-4">
            <Button
              ...
              disabled={transforming || transformation === null}
